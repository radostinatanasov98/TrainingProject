class UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'create_should_return_422_without_email' do
    post '/api/users/create',
         params: { password: '123456', first_name: 'test', last_name: 'test', address: 'test',
                   date_of_birth: '2022-06-13 12:53:52.005776', client_id: 'test_uid' }
  ...
  test 'create_should_return_422_without_password' do
    post '/api/users/create',
         params: { email: 'test_create@test.com', first_name: 'test', last_name: 'test', address: 'test',
                   date_of_birth: '2022-06-13 12:53:52.005776', client_id: 'test_uid' }
  ...
  test 'create_should_return_422_without_first_name' do
    post '/api/users/create',
         params: { emial: 'test', password: '123456', last_name: 'test', address: 'test',
                   date_of_birth: '2022-06-13 12:53:52.005776', client_id: 'test_uid' }
  ...
  test 'create_should_return_422_without_last_name' do
    post '/api/users/create',
         params: { email: 'test_create@test.com', password: '123456', first_name: 'test', address: 'test',
                   date_of_birth: '2022-06-13 12:53:52.005776', client_id: 'test_uid' }
  ...
  test 'create_should_return_422_without_address' do
    post '/api/users/create',
         params: { email: 'test_create@test.com', password: '123456', first_name: 'test', last_name: 'test',
                   date_of_birth: '2022-06-13 12:53:52.005776', client_id: 'test_uid' }
  ...
  test 'create_should_return_422_without_date_of_birth' do
    post '/api/users/create',
         params: { email: 'test_create@test.com', password: '123456', first_name: 'test', last_name: 'test',
                   address: 'test', client_id: 'test_uid' }
  ...
  test 'create_should_return_200_with_valid_params' do
    post '/api/users/create',
         params: { email: 'test_create@test.com', password: '123456', first_name: 'test', last_name: 'test',
                   address: 'test', date_of_birth: '2022-06-13 12:53:52.005776', client_id: 'test_uid' }
