...
Role.create(name: 'admin', description: 'Administrator') unless Role.exists?(1)

unless Role.exists?(2)
  Role.create(name: 'patient',
              description: 'Has acess to their own examinatiosn and perscriptions.')
end

unless Role.exists?(3)
...
Examination.create(user_id: 1, weight_kg: 80, height_cm: 180, anamnesis: 'test') unless Examination.any?
